...
/**
 * Historical prompt template for incident-classification-v1.
 * Preserved for audit; active classification uses incident-classification-v3.
 */
export const PROMPT_VERSION = "incident-classification-v1";
...
- Every evidence excerpt MUST be copied verbatim from the incident description (exact substring).
- Do not invent facts, injuries, or behaviours absent from the description.
- Keep each excerpt short and focused (roughly one phrase or clause).
- If uncertain, use "uncertain" in the relevant assessment field.
